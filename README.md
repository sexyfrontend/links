...
- [css-live.ru](http://css-live.ru/) Сайт посвященный html/css. Там можно найти множество интересных решений и полезных статей. Сайт существует уже довольно давно, так что накопилось много полезного материала.
...
###Списки
- [htmllinks.ru](http://htmllinks.ru/) Полезные ссылки для web разработчика
- [stackshare.io](http://stackshare.io/stacks) Список популярных сервисов с их стеком технологий
- [webfieldmanual.com](http://webfieldmanual.com/) Очень хороший список ресурсов для дизайнера и разработчика. Разбиты на категориям.

###Подкасты, каналы на youtube e.t.c.
- [radioJS](https://radiojs.ru/ ) Интеренсный подксат для front-end разработчиков. 
